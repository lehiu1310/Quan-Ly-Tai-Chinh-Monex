...
class TotalSalaryPage extends StatefulWidget {
  const TotalSalaryPage({super.key});
...
class _TotalSalaryPageState extends State<TotalSalaryPage>
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: MonexColors.income.withValues(alpha: 0.1),
            ),
          ),
          Container(
      ...
      child: Column(
        children: [
          TabBar(
            ...
            indicatorColor: MonexColors.income,
  ...
  Widget _buildIncomesList() {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) => _buildTransactionRow(incomes[index]),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(entry.icon, color: MonexColors.income),
          ),
